    ...
    public class ObjectsPoolEditor : Editor
    {
        ...
        private void PoolArea(Pool pool)
        {
            ...
            if (pool.foldout)
            {
                ...
                pool.audioSourceHandling = (ComponentHandlingType)EditorGUILayout.EnumFlagsField("Audio source: ", pool.audioSourceHandling);
                pool.particleSystemHandling = (ComponentHandlingType)EditorGUILayout.EnumFlagsField("Particles: ", pool.particleSystemHandling);
